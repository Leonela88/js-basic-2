...
// //Ejercicio 10: Con un bucle for in imprime en pantalla todos los nombres, apellidos y su aporte a la sociedad de las programadoras de la historia
//  contenidas en el array llamado 'programmers', 
...
for (let $info in programmers ){
    const value=programmers[$info];
    
    console.log(`${$info}:${value.name} ${value.lastname},su aporte fué ${value.knowledge}`);
}


// //Ejercicio 11: Con un bucle for of imprime en consola
//  "Hola, mi nombre es ... " y reemplaza los tres 
// puntos con cada nombre del array dado.
...
for ( let friends of names){
    ...
    console.log(`Hola, mi nombre es, ${friends}`);
}
...
function saludar(nombre) {
  return `¡Hola, ${nombre}! Bienvenid@ al lanzamiento de mi video!!!.`;
}

console.log(saludar("Flor"));
console.log(saludar("Luis"));
console.log(saludar("Fanni"));
console.log(saludar("Noe"));
...
console.log(`Área (20 x 10): ${calcularAreaRectangulo(20, 10)}`);
console.log(`Área (15 x 6): ${calcularAreaRectangulo(15, 6)}`);
